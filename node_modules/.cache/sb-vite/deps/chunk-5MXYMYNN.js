...
import {
  ...
  rgba,
  withReset
} from "./chunk-BFZE6RL7.js";
import {
  ActionBar
} from "./chunk-6I4FKTUW.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-L3HZ4ETH.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-7DS44UD5.js";
import {
  v
...
import {
  stringify
} from "./chunk-ABRUJSFN.js";
import {
  require_uniq
} from "./chunk-VQMAV5OJ.js";
import {
  index_modern_default
} from "./chunk-UV4CTXKD.js";
import {
  require_memoizerific
} from "./chunk-S5U5TOQW.js";
import {
  _extends,
  ...
  rgba as rgba2
} from "./chunk-CJMW2NGX.js";
import {
  require_pickBy
} from "./chunk-DBITEG3X.js";
import {
  require_mapValues
} from "./chunk-77I6AZM6.js";
import {
  require_cloneDeep
} from "./chunk-6VDCA3P5.js";
import {
  renderElement,
  unmountElement
} from "./chunk-V3UGSNBW.js";
import {
  require_react_dom
} from "./chunk-ITDYQSRO.js";
import {
  require_preview_api
} from "./chunk-AVJXZ2DN.js";
import {
  require_react
} from "./chunk-UVSQZMOW.js";
import {
  require_channels
...
var Photo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Images-S2WTXNGG-3CN3RGYR.js");
...
var Book = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Documents-SGWAY3KW-GSMPMMGO.js");
...
var Markup = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Editing-7QFB6ZMG-JWXSBWZO.js");
...
var Repo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Git-DZ2D5ZUL-D762J2A4.js");
...
var Apple = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./OS-YZ2Y4VYS-DBO724OF.js");
...
var Storybook = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Logos-SJTNNI74-EFSJXBY3.js");
...
var Browser = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Devices-SUYACUPO-ZZ7TJIE2.js");
...
var Edit = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./CRUD-I5EZL2FS-BUT4VVLC.js");
...
var Info = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Communicate-7JXCND2Z-VVUKCLOM.js");
...
var ChevronUp = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Wayfinding-BB4H7CHP-CSF3BFGD.js");
...
var User = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./People-OD4EV7WZ-4SIZV2H2.js");
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react27.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react27.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react27.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-KYN7C76J.js");
...
var LazyColorControl = (0, import_react27.lazy)(() => import("./Color-6VNJS4EI-V2VPQ5J3.js"));
...
var ErrorBoundary = class extends import_react28.Component {
  constructor() {
    super(...arguments);
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./@mdx-js_react.js").then(({ MDXProvider }) => renderElement(import_react28.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react28.default.createElement(MDXProvider, { components }, import_react28.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=chunk-5MXYMYNN.js.map
