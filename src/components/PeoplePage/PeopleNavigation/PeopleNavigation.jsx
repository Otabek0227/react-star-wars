...
export default function PeopleNavigation({ getResponse, prevPage, nextPage, counterPage }) {
  ...
  return (
    <div className='d-flex w-100 justify-content-center'>
      <Link to={`react-star-wars/people/?page=${prevPage && counterPage - 1}`} className={styles.navigationBtn}>
        <UiButton onClick={onPrevPage} disabled={!prevPage}>Previous</UiButton>
      </Link>
      <Link to={`react-star-wars/people/?page=${nextPage && counterPage + 1}`} className={styles.navigationBtn}>
